...
const _sfc_main = {
  ...
  methods: {
    ...
    goToPost() {
      common_vendor.index.navigateTo({ url: "/pages/post/post?type=traveler" });
    },
    showDetail(item) {
      common_vendor.index.__f__("log", "at pages/travel/travel.vue:146", "显示详情", item);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.p({
      title: "可用额度",
      value: $data.currentItem.capacity || ""
    }),
    o: common_vendor.p({
      title: "备注",
